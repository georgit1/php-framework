# PHP Framework with Transaction Tracker Project

This repository contains a custom PHP framework. The framework serves as the foundation for a transaction tracker project that includes authentication and CRUD functionality.
